              ...
              <div className="grid gap-5">
                  ...
                  <Field name="services">
                    {({ field }: any) => (
                      <CustomSelect
                        ...
                        ref={(ref: any) => {
                          fieldRefs.current['service_id'] =
                            ref?.control?.control?.controlRef || ref;
                        }}
                      />
                    )}
                  </Field>
                ...
                <div className="flex items-baseline flex-wrap gap-2.5">
                  ...
                  {touched.service_delivered_options && errors.service_delivered_options && (
                    <span role="alert" className="text-danger text-xs mt-1">
                      {errors.service_delivered_options as string}
                    </span>
                  )}
                </div>
                <div className="flex items-baseline flex-wrap gap-2.5">
                  ...
                  {touched.age_group_options && errors.age_group_options && (
                    <span role="alert" className="text-danger text-xs mt-1">
                      {errors.age_group_options as string}
                    </span>
                  )}
                </div>
                <div className="flex items-baseline flex-wrap gap-2.5">
                  ...
                  {touched.language_options && errors.language_options && (
                    <span role="alert" className="text-danger text-xs mt-1">
                      {errors.language_options as string}
                    </span>
                  )}
                </div>
