...
import { updateParticipant, getSingleParticipant, fetchIncidentCustomers } from '@/services/api';
      ...
      const fetchParticipant = async () => {
        try {
          ...
          setInitialValues({
            ...
            assigned_practitioner_id: participant.assigned_practitioner_id ? String(participant.assigned_practitioner_id) : '',
            ...
            behaviours_of_concern: participant.behaviours_of_concern || '',
            triggers_antecedents: participant.triggers_antecedents || '',
            early_warning_signs: participant.early_warning_signs || '',
            escalation_patterns: participant.escalation_patterns || '',
            behaviour_overview_summary: participant.behaviour_overview_summary || '',
            behavioural_tendencies: participant.behavioural_tendencies || '',
            proactive_strategies: participant.proactive_strategies || '',
            reactive_strategies: participant.reactive_strategies || '',
            escalation_steps: participant.escalation_steps || '',
            restricted_practices: participant.restricted_practices || '',
            support_requirements: participant.support_requirements || '',
            risk_indicators: participant.risk_indicators || '',
            risk_factors: participant.risk_factors || '',
            sensory_profile: participant.sensory_profile || '',
            communication_style: participant.communication_style || '',
            environmental_needs: participant.environmental_needs || '',
            support_environment_family_context: participant.support_environment_family_context || '',
            functional_daily_living_profile: participant.functional_daily_living_profile || ''
          });
          setLoading(false);
        } catch (error) {
