interface IOrganizationsData {
  service: string;
  description: string;
  deliveringMean: string;
  supportedAgeGroup: number;
  supportedLanguage: string;
  deliveringAddress: string;
  ServiceAvailableAddress: string;
  status: boolean;
  lastModified: string;
}
enum ServiceType {
...
const OrganizationsData: IOrganizationsData[] = [
  {
...
export { OrganizationsData, type IOrganizationsData };
