  ...
  const renderContent = () => {
    return (
      <div
        ...
        className={clsx(
          'sidebar bg-[#752C84] lg:border-e lg:border-e-gray-200 dark:border-e-coal-100 lg:fixed lg:top-0 lg:bottom-0 lg:z-20 lg:flex flex-col items-stretch shrink-0',
          themeClass
          //
        )}
      >
  ...
  if (desktopMode) {
    ...
    return (
      <Sheet open={mobileSidebarOpen} onOpenChange={setMobileSidebarOpen}>
        <SheetContent
          className="border-0 bg-[#752C84] p-0 w-[--tw-sidebar-width] scrollable-y-auto"
          forceMount={true}
          side="left"
          close={false}
        >
